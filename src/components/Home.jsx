  ...
  return (
    <div name='home' className='w-full h-screen bg-[#061337]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <h1 className='my-2 text-6xl font-extrabold text-yellow-400 hover:bg-red-700 duration-500 shadow-md hover:shadow-lg'>Kunal Kaushik</h1>
        ...
        <p className='my-4 text-[#94a3b8] '>Hello, I'm Kunal, a beginner web developer passionate about crafting dynamic and user-friendly web applications. With expertise in the MERN stack (MongoDB, Express.js, React, and Node.js) and proficiency in Tailwind CSS, I bring creativity and functionality to my projects. I'm excited to contribute my knowledge and collaborate on meaningful projects</p>
